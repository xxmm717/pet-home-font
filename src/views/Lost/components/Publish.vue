  ...
  <div class="pub_contianer">
    <div class="detail">
      ...
      <el-form v-model="form" label-width="120px">
        ...
        <!-- 上传图片 -->
        <el-form-item label="选择图片(最多上传3张)">
          <el-upload  list-type="picture-card" action="http://localhost:8000/lost/upload" :http-request="uploadImage" limit="3"
...
<script setup>
import { ref } from "vue"
import { uploadApi } from "@/apis/lostApi";
...
const submitForm = async () => {
  ...
  await uploadApi(formData,pictures.value)
  ElMessage({
      type: 'success',
      message: '发布成功'
    })
