...
import { RRemoveApi } from '@/apis/adminApi'
...
const inside = (id) => {
  ...
  router.push({ name: 'rmInside', params: { 'id': id } })
}
//渲染
const getList = async () => {
...
const toUpdate = (id) => {
  router.push({ name: 'rmUpdate', params: { 'id': id } })
}
